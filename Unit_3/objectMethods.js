...
// * Object.keys() Method - returns an array of our keys
console.log("Keys: ", Object.keys(theSimpsons));

// * Object.values() Method - returns an array of our values
console.log("Values: ", Object.values(theSimpsons));

// * Object.create() Method - uses an existing object to frame out a new object, we use a variable to store the base of the object creation
const futurama = Object.create(theSimpsons);
//console.log(futurama); // just brackets so far!
futurama.id = 2;
futurama.est = 1999;
console.log(futurama);
// the keys are invisible but easily assigned values!
